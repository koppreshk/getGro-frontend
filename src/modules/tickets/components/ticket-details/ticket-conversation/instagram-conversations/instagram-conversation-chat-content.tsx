...
const Content = styled(FlexBox) <{ $isCustomerQuery: boolean }>`
    background-color: ${({ $isCustomerQuery }) => $isCustomerQuery ? '#efefef' : '#6e2dff'};
    padding: 10px;
...
interface IInstagramChatContentProps extends Pick<ITicketConversation, 'agentName' | 'customerName'> {
    content: {
...
export const InstagramConversationChatContent = (props: IInstagramChatContentProps) => {
