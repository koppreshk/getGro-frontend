...
export const EmailHeaderOptions = (props: {
  editorType: 'forward' | 'reply';
}) => {
  ...
  return (
    ...
    >
      <FlexBox width="100%">
        ...
        <FlexBox gap="10px">
          {!showCCTagInput && (
            <StyledTypography variant="h6" onClick={onCCTextClick}>
              Cc
            </StyledTypography>
          )}
          {!showBCCTagInput && (
            <StyledTypography variant="h6" onClick={onBCCTextClick}>
              Bcc
            </StyledTypography>
          )}
        </FlexBox>
