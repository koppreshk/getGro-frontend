...
import { TicketOverviewContainer, PastTicketsContainer } from "modules/tickets/containers";
...
export const TicketDetailsSection = () => {
    ...
    const customerId = useAppSelector((state) => state.tickets.ticketDetails?.shopifyCustomerId);
