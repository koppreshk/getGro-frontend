...
export const OrderDetailsContainer = (props: { customerId: string | null | undefined }) => {
    const { customerId } = props;

    const { watch } = useFormContext();
    const { data: orderData, isLoading: orderDataLoading } = useFetchAllOrders(watch('stores'), customerId!);
