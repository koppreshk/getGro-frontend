...
export const ForgotPassword = () => {
    ...
    return (
        <FormProvider {...formMethods}>
            <Link variant="subtitle2" underline="none" sx={{ fontSize: '16px', cursor: 'pointer' }} onClick={handleClick}>{t('forgot_password')}</Link>
            ...
            <Dialog open={open} fullWidth maxWidth="sm">
                ...
                <DialogContent>
                    {!isSubmit ?
                        <>
                            <Typography variant='body2'>{t('forgot_password_description')}</Typography>
                        ...
                        :
                        <FlexBox width="100%" flexDirection="column" gap={'20px'} alignItems='center'>
                            ...
                            <Typography variant='body2'>
                                If you haven't received the email, <Link onClick={onSubmit} sx={{ cursor: 'pointer' }}>Click here</Link> to resend it.
                            </Typography>
                        </FlexBox>
                    }
