...
export const RolesPermissionsTab = () => {
    ...
    const defaultValues = {
        description: '',
        modules: config!.modules.reduce((acc, curr) => {
        ...
        name: config!.role!,
        permissions: config!.permissions.reduce((acc, curr) => {
            acc[curr] = true;
            return acc;
        }, {} as {
    ...
    return (
        <FormProvider {...formMethods}>
            <FlexBox flexDirection="column" gap="10px" width="100%" height="100%" overflowY="auto" overflowX="auto">
