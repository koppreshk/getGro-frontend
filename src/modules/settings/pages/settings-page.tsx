...
import { FacebookConfigurations, InstagramConfiguration } from "../component/channel-configurations"
...
export default function ConfigurationsPage() {
    return (
        <Routes>
            ...
            <Route key="instagram" path="/instagram" element={<InstagramConfiguration />} />
        </Routes>
    )
}
