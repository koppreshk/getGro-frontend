...
import { WhatsAppConfigurationQueryKey, WhatsAppConfigurationEndPoint } from "./api-enums";
...
export const useDeleteWhatsAppNumber = () => {
    ...
    const deleteWhatsAppNumber = React.useCallback((args: IDeleteWhatsAppNumber) =>
        postData(WhatsAppConfigurationEndPoint.DELETE_WHATSAPP_NUMBER, args), [postData])
