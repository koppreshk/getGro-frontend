...
import { ICreateWhatsAppArgs, WhatsAppConfigurationEndPoint, WhatsAppConfigurationQueryKey } from ".";
import { useMutation } from "react-query";

export const useEditWhatsAppConfigurations = () => {
    const { postData } = useServiceClient();

    const editWhatsAppConfig = React.useCallback((args: ICreateWhatsAppArgs) =>
