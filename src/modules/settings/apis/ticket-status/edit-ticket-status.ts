...
export const useEditTicketStatus = () => {
    ...
    const editDisposition = React.useCallback((args: IEditStatusArgs) => postData(StatusTypeEndPoint.EDIT_STATUS, { id: args.id, name: args.name }).then((res) => res.json()), [postData]);
