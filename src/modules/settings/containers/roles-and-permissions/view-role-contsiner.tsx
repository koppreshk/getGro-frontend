...
export const ViewRoleContainer = (props: ViewRoleContainerProps) => {
  ...
  const allKnowledgeBasePermissions = Object.values(
    KnowledgeBasePermissionKeys
  );
  const allPermissions = [
    ...
    ...allKnowledgeBasePermissions,
  ] as AllPermissionKeys[];

  const defaultValues = {
    description: selectedRole.description,
    modules: Object.values(ModuleKeys).reduce(
      (acc, curr) => {
  ...
  return <CreateRole defaultValues={defaultValues} mode="view" />;
};
