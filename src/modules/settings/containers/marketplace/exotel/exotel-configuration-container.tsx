...
export const ExotelConfigurationContainer = () => {
    ...
    const updateInstallation = () => {
        refetch().then(() => {
            showNotification({ message: 'Congrats! Exotel configuration is added!', type: 'success' });
        });
    };
    ...
    if (data) {
        return <ExotelConfiguration data={data || {}} updateInstallation={updateInstallation} />
    }
