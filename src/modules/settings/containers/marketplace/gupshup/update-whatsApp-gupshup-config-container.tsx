...
import {
  ISetupGupShupArgs,
  useEditGupShupConfigurations,
  useFetchGupshupConfiguration,
...
export const UpdateWhatsAppGupshupConfigContainer = (
  props: IUpdateWhatsAppGupshupConfigContainerProps
) => {
  const {
    data: currentData,
    error,
  ...
  if (currentData) {
    return (
      <EditWhatsAppGupshupConfigFormBase
