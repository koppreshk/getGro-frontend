        ...
        <FormProvider {...form}>
            <FlexBox width="100%">
                <FlexBox gap={'20px'} flexDirection="column" padding="20px" width="100%">
                    <TextboxFieldWithLabel name="name" disabled={mode === 'userProfile'} sx={{ width: '70%' }} label={t('role_name')} size="small" rules={{ required: t('name_is_required') }} />
                    {mode !== 'userProfile' ? <TextboxFieldWithLabel name="description" label={t('description')} sx={{ width: '70%' }} size="small" /> : null}
