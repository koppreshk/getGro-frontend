    ...
    return (
        <FlexBox flexDirection="column" width="100%">
            <Typography variant="body2" paragraph>
                WhatsApp integration is a cloud-based communication platform enabling businesses to manage customer interactions via calls.
                It offers features such as virtual numbers and IVR systems for seamless communication.
            </Typography>
            <Typography variant="body2" paragraph>
                Integrate WhatsApp integration into GetGro to streamline call management processes, enabling businesses to effortlessly make
                and receive calls and tracking the call history in real-time.
            </Typography>
            <Typography variant="body2" paragraph>
                The WhatsApp integration integration offers the following valuable features, Within the GetGro
            </Typography>
            <ul>
                <li><b>Number Assignment:</b> Allocate various WhatsApp integration numbers to distinct categories, streamlining call prioritization.</li>
...
const InstallationContents = () => {
    return (
        <FlexBox width="100%" flexDirection="column">
            <Typography variant="body2" paragraph>
                To install and connect WhatsApp  integration with GetGro, follow the instructions in the following links:
            </Typography>
