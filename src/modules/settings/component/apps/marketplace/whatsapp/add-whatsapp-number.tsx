...
export const AddWhatsAppNumberFormBase = (
  props: IAddWhatsAppNumberFormProps
) => {
  const {
    togglePopup,
  ...
  return (
    <FormProvider {...form}>
      <FlexBox gap="20px">
        ...
        {activeStep === 0 ? <AccountConfigurations /> : <ChatConfiguration />}
      </FlexBox>
      <DialogActions
