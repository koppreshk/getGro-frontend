          ...
          {manageBtnClicked ? (
            <>
              ...
              <Button
                variant="contained"
                size="medium"
                onClick={secondaryBtnActions?.onSecondaryBtnClk}
              >
                {secondaryBtnActions?.secondaryBtnLabel}
              </Button>
            </>
          ) : showManageBtn ? (
            <Button variant="outlined" size="medium" onClick={onManageBtnClick}>
              Manage
            </Button>
          ) : null}
