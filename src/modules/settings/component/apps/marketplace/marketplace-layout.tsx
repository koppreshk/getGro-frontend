...
const useThirdPartyApps = () => {
  ...
  return [
    ...
    // },
    {
      ...
      label: 'WhatsApp',
      description:
        'Enhance customer engagement with getgro WhatsApp integration',
      ...
      iconElement: () => (
        <Instagram
          sx={{
            width: '40px',
            height: '40px',
            fill: theme.channelSpecific.instagram + '!important',
          }}
        />
      ),
    },
    {
      ...
      label: 'Facebook',
      description:
        'Enhance customer engagement seamlessly with Getgro Facebook Integration.',
      iconElement: () => (
        <Facebook
          sx={{
            width: '40px',
            height: '40px',
            fill: theme.channelSpecific.facebook + '!important',
          }}
        />
      ),
    },
    ...
    <>
      <Routes>
        ...
        <Route
          key="shopify-route"
          path="shopify"
          element={<ShopifyConfigurationContainer />}
        />
        <Route
          key="exotel-route"
          path="exotel"
        ...
        <Route
          ...
          path="whatsapp"
          element={<WhatsappConfigurationContainer />}
        />
        <Route
          key="instagram-route"
          path="instagram"
          element={<InstagramConfigurationContainer />}
        />
        <Route
          key="facebook-route"
          path="facebook"
          element={<FacebookConfigurationContainer />}
        />
      </Routes>
    </>
  );
