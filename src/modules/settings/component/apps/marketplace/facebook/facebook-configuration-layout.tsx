    ...
    return (
        <FlexBox flexDirection="column" width="100%">
            <Typography variant="body2" paragraph>
                Getgro enhances customer service on Facebook with seamless integration. Effortlessly manage Facebook messages alongside other channels, all from one, unified platform.
            </Typography>
...
const InstallationContents = () => {
    return (
        <FlexBox width="100%" flexDirection="column">
            <Typography variant="body2" paragraph>
                To install and connect Facebook  integration with Getgro, follow the instructions in the following links:
            </Typography>
            <Typography component="a" variant="body2" href="https://support.getgro.com/kb/article/506/set-up-Facebook">
    ...
    return (
        <AppConfig>
            <AppConfig.Header
                ...
                appTitle="Facebook"
                appIcon={() => <Facebook sx={{ width: '60px', height: '60px', fill: channelSpecific.facebook + '!important', }} />}>
