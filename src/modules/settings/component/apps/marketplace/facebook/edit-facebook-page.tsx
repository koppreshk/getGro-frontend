...
export const EditFacebookPage = (props: {
  ...
  return (
    <>
      <CustomIconButton
        ...
        iconComponent={<Edit />}
        tooltipProps={{ title: 'Edit Facebook page', arrow: true }}
      />
      <AddAppConfigurationDialog
        dialogContent={() => (
          <EditFacebookPageContainer
            toggleAddPageDialog={toggleAddAccountDialog}
