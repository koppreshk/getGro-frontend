...
const steps = [
  ...
  },
  {
    ...
    description:
      'Set up the auto-reply features and queue configuration for Instagram in Getgro.',
  },
];

const MessengerConfiguration = (
  props: Pick<IAddInstagramConfigurationFormProps, 'allQueues'>
) => {
      ...
      <FlexBox flexDirection="column" gap="20px" width="75%">
        <FlexBox gap="20px">
          <FlexBox flexDirection="column">
            ...
            <Typography variant="body3">
              {t('auto_reply_description')}
            </Typography>
            {watch('sendAutoReply') ? (
              <TextboxField
                sx={{ mt: '20px' }}
                name="autoReplyMessage"
                label={t('auto_reply_message')}
                multiline
                rows={4}
              />
            ) : null}
        ...
        <FlexBox flexDirection="column" gap={'5px'}>
          ...
          <Typography variant="caption">
            Chats will automatically be assigned to the selected Queue
          </Typography>
        </FlexBox>
      </FlexBox>
    </>
      ...
      <>
        {watch('commentsConfiguration') === 'specific_keywords' ? (
          <FlexBox flexDirection="column" gap={'20px'} padding={'0 0 0 27px'}>
            <Typography variant="body3">
              {
                'If you turn this feature on, comment with specific keywords for your post will be converted into conversation'
              }
            </Typography>
            <StyledTagInputField
              name="keywords"
          ...
          radioOptions={[
            {
              ...
              renderContentBelowLabel:
                'If you turn this feature on, all comments received on your posts will be converted into conversations',
            },
            {
              key: 'specific_keywords',
              label: t('comments_specific_keywords'),
              renderContentBelowLabel: renderContentBelowLabel,
            },
          ]}
        />
      </FlexBox>
...
export const AddInstagramConfigurationFormBase = (
  props: IAddInstagramConfigurationFormProps
) => {
  const {
    togglePopup,
  ...
  const onSubmitForm = async (
    formFields: IAddInstagramConfigurationFormFields
  ) => {
    onSubmit(formFields);
  };
  ...
  const renderBasedOnStep = () => {
    switch (activeStep) {
      ...
      default:
        return <MessengerConfiguration allQueues={props.allQueues} />;
    }
  };
      ...
      >
        ...
        <FlexBox gap="10px">
          ...
          <LoadingButton
            ...
            variant="contained"
            onClick={isLastStep ? form.handleSubmit(onSubmitForm) : handleNext}
          >
