      ...
      cell: ({ row: { original } }) => {
        return (
          <FlexBox flexDirection="row" gap="5px">
            <CustomIconButton
              iconComponent={<Edit />}
              tooltipProps={{ title: 'Edit Store', arrow: true }}
            />
  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      <AddAppConfigurationDialog
        dialogContent={() => (
          <EditShopifyConfigurationContainer
            storeData={storeMetadata as IShopifyStore}
