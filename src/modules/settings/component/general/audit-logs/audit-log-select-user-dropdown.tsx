...
export const AuditLogSelectUser = React.memo(
  (props: IAuditLogSelectUserProps) => {
...
const AuditLogSelectUserComponent = React.memo(
  (props: IAuditLogSelectUserComponentProps) => {
