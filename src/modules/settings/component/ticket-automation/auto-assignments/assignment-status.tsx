...
import { AutoMationType, useSetAssignmentStatus } from "modules/settings/apis/ticket-automation";
import { useState } from "react";
import { useTranslation } from "react-i18next";

export const AssignmentStatus = (props: { status: boolean, id: number, autoMationType: AutoMationType }) => {
