...
export const ChooseConditionForm = (props: ChooseConditionFormProps) => {
  ...
  const validateRuleName = (value: string) => {
    const modifiedData =
      mode === 'edit'
        ? allAssignments?.filter((item) => item.name !== ruleName)
        : allAssignments;
  ...
  return (
    <FlexBox flexDirection="column" gap={'20px'}>
      <TextboxFieldWithLabel
        ...
        size="small"
        rules={{
          required: t('rule_name_validation'),
      ...
      <FlexBox flexDirection="column" alignItems="center" width="100%">
        <TicketConditions
          ...
          heading={
            <Typography variant="body2">
              <Trans i18nKey={'rule_text_all_condtions'} />
            </Typography>
          }
        />
        <ConditionCombiner />
        <TicketConditions
          ...
          heading={
            <Typography variant="body2">
              <Trans i18nKey={'rule_text_any_condtions'} />
            </Typography>
          }
        />
      </FlexBox>
