    ...
    const renderBasedOnActiveStep = () => {
      switch (activeStep) {
        case 0:
          return (
            <ChooseCondition
              ticketField={data.ticket_fields}
              priorities={data.priorities}
              allEscalations={allEscalations}
              mode={props.mode}
              slaName={defaultvalues?.chooseCondition.name}
            />
          );
        case 1:
          return (
            <SLATargets
              timeOptions={data.run_types}
              slaTargetPriorities={data.priorities}
            />
          );
        case 2:
          return (
        ...
        default:
          return (
            <AddEscalation
              escalationTimes={data.escalation_types}
              queueList={data.queue_list}
              userList={data.user_list}
            />
          );
