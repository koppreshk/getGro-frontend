export const DashboardEndPoint = {
  FETCH_DASHBOARD_DATA: 'dashboard/fetch_dashboard_data', // not used anymore, need to confirm and remove
...
export const DashboardQueryKeys = {
  ...
  FETCH_DROPDOWN_VALUES: 'FETCH_DROPDOWN_VALUES_AGENT_PERFORMANCE',
