...
const CustomerSurveyPage = lazy(
  () => import('../../survey/pages/customer-survey')
);
const SetNewAgentPassword = lazy(
  () => import('../../login/set-new-agent-password')
);
...
const KnowledgeBasePage = lazy(
  () => import('../../knowledge-base/pages/knowledge-base-page')
);
const CustomersPage = lazy(
  () => import('../../customers/pages/customers-page')
);
const ChatsPage = lazy(() => import('../../chats/pages/chat-layout-page'));
const ConfigurationsPage = lazy(
  () => import('../../settings/pages/settings-page')
);
const UserProfilePage = lazy(
  () => import('../../user-profile/pages/user-profile-page')
);
    ...
    <Routes>
      <Route element={<ProtectedRoute />}>
        <Route key="root" path="/" element={<HomePage />}>
          ...
          />
          <Route key="chats" path="chat/*" element={<ChatsPage />} />
          <Route
            key="configurations"
            path="configurations/*"
