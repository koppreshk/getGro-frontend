...
export const LinkTicket = () => {
    ...
    return (
        <>
            <Button onClick={toggleLinkTicketDialog} variant="text" sx={{ height: '40px' }}><Trans i18nKey="link_tickets" /></Button>
            <LinkTicketDialog openLinkTicketDialog={openLinkTicketDialog} toggleLinkTicketDialog={toggleLinkTicketDialog} />
        </>
    )
}