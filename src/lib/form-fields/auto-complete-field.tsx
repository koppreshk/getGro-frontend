...
import Autocomplete, { AutocompleteOwnerState, AutocompleteRenderOptionState } from "@mui/material/Autocomplete/Autocomplete";
...
export type AutoCompleteRenderOptionProps = (
    ...
    ownerState: AutocompleteOwnerState<any, boolean | undefined, boolean | undefined, boolean | undefined, ChipTypeMap['defaultComponent']>,
) => React.ReactNode;
...
export const AutocompleteField = (props: IAutocompleteFieldProps) => {
    const { name, options = [], label, placeholder, size = 'medium', getOptionLabel, renderOption } = props;
        ...
        <Controller
            ...
            render={({ field: { onChange, ref, ...rest } }) => (
                <Autocomplete
                    ...
                    limitTags={3}
                    size={size}
                    getOptionLabel={(option) => getOptionLabel ? getOptionLabel(option) : option.value}
