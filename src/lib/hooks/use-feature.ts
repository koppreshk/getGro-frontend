...
type UseFeatureReturnType<T> = T extends undefined | null
  ? (featName: AllPermissionKeys) => boolean
  : boolean;
...
type UseModuleReturnType<T> = T extends undefined | null
  ? (featName: AllModules) => boolean
  : boolean;
